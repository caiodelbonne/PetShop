...
async function carregarHorariosAgendados() {
    try {
        ...
        horariosAgendados = data.agendamentos.map(agendamento => agendamento.data.split(" ")[1]); // Apenas o horário
    } catch (error) {
...
async function atualizarHorariosDisponiveis() {
    ...
    await carregarHorariosAgendados(); // Aguarda o carregamento correto dos horários
